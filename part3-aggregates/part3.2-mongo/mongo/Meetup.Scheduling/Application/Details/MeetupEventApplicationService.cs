...
namespace Meetup.Scheduling.Application.Details
{
    ...
    {
        readonly MongoDbRepository<MeetupEventDetailsAggregate> MeetupEventRepository;
        readonly IDateTimeProvider DateTimeProvider;

        public MeetupEventDetailsApplicationService(MongoDbRepository<MeetupEventDetailsAggregate> meetupEventRepository,
        ...
        async Task<CommandResult> Handle(string id, Action<MeetupEventDetailsAggregate> action)
        {
